...
export default function Proyect({
  ...
  return (
    <article className="w-51/60 mx-auto max-w-xl flex flex-col items-center h-full justify-between sm:max-w-xl bg-gray-800 border border-gray-600 shadow-lg rounded-lg p-4 transform transition-transform md:hover:scale-105">
